...
Resource::Resource(Microsoft::WRL::ComPtr<CD3DX12AffinityResource> resource, const std::wstring& name)
...
void Resource::SetD3D12Resource(Microsoft::WRL::ComPtr<CD3DX12AffinityResource> d3d12Resource, 
